...
rem Compile C++ code
g++ raytracer.cpp cameras/*.cpp geometry/*.cpp lights/*.cpp materials/*.cpp samplers/*.cpp BRDF/BRDF.cpp BRDF/Lambertian.cpp utilities/*.cpp world/*.cpp build/"build%file_type%%source_file%".cpp -o a.exe
